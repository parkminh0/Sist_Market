    ...
    return (
        ...
        <Card sx={{ width: '200px',
          ...
          <div style={{ width: '100%',  minwidth: '0', marginLeft: '5px'}}>
            ...
            >{pvo.title}</Typography>
            <Typography level="body-sm">위치 · 동네 · {timeDifference(pvo.create_dtm)}
        </Typography>
          </div>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection:'column',alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', marginLeft: '0' }}>
                <IconButton variant="plain" size="sm" sx={{ padding: '0 4px' }}>
                  <RemoveRedEyeOutlinedIcon style={{ fontSize: '14px' }} />
                </IconButton>
                <span style={{ fontSize: '12px', marginLeft: '0' }}>{pvo.viewqty}</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', marginLeft: '0' }}>
                <IconButton variant="plain" size="sm" sx={{ padding: '0 4px' }}>
