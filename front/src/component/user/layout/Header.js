...
export default function Header(){
    ...
    useEffect(() => {
        ...
        if (activeLink) {
          ...
          document.querySelectorAll('a[data-href]').forEach(link => link.classList.remove('_1nvz3xsp'));
    ...
    <div className="_6vo5t01 _6vo5t00 _588sy4n8 _588sy4nl _588sy4o4 _588sy4on _588sy4ou _588sy4p7 _588sy4k2 _588sy4kf _588sy4ky _588sy4lh _588sy4lo _588sy4m1 _588sy4n _588sy462">
        <div className="_1a7kymo5 _1h4pbgy7e8 _1h4pbgy7ej _1h4pbgy7iw _1h4pbgy7j7 _1h4pbgy1u0 _1h4pbgya0o _1h4pbgy98o _1h4pbgy9ug _1h4pbgy9xs">
            <div className="_1h4pbgy9ug _1h4pbgy9wo _1h4pbgy8rk">
                <Link data-gtm="gnb_logo" href="/" className="_1h4pbgy9ug _1h4pbgy9wo _1h4pbgy9yw">
            ...
            <div>
                <nav className="_1h4pbgy9u0 _1h4pbgy9uj _1h4pbgy9wo">
                    <HeaderItem/>
                    <button onClick={show_login_dialog('account')} id="show_login" style={{backgroundColor:"#ff6f0f24", color:"#ff6f0f"}} className="seed-box-button" data-scope="button" data-part="root" type="button" data-gtm="gnb_app_download" data-size="xsmall" data-variant="primaryLow">
        ...
        <div className="_1a7kymoh _1h4pbgy89k _1h4pbgy8eg _1h4pbgya0o _1h4pbgy9ug _1h4pbgy8jc _1a7kymog" data-expanded="true">
            <div className="_1h4pbgy9u0 _1h4pbgy9ub _1h4pbgy8bk">
                <button onClick={getLocation} className="lrcwe20 _1h4pbgy8g _1h4pbgy9ug _1h4pbgy9wo _1h4pbgy17c _1h4pbgy7ag _1h4pbgy9yw lrcwe22 _1h4pbgy7nk _1h4pbgy7s8 _1h4pbgy780" data-gtm="gnb_location">
                    <span style={{display:"inline-flex"}} className="_1h4pbgy8gg _1h4pbgy8qo _1h4pbgy8ao" data-seed-icon="icon_location_fill" data-seed-icon-version="0.2.1">
                        <svg id="icon_location_fill" width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-karrot-ui-icon="true">
                            <g>
                            <path fillRule="evenodd" clipRule="evenodd" d="M2.19995 10.5798C2.19995 5.16739 6.58756 0.779785 12 0.779785C17.4123 0.779785 21.8 5.16739 21.8 10.5798C21.8 13.9799 19.5985 17.1391 17.4217 19.3764C16.3174 20.5113 15.1817 21.4481 14.2536 22.1055C13.7903 22.4337 13.3694 22.6988 13.0225 22.8857C12.8498 22.9788 12.6843 23.0584 12.5339 23.1169C12.4059 23.1666 12.2081 23.2342 12 23.2342C11.7918 23.2342 11.594 23.1666 11.466 23.1169C11.3156 23.0584 11.1501 22.9788 10.9774 22.8857C10.6305 22.6988 10.2096 22.4337 9.74627 22.1055C8.81823 21.4481 7.68247 20.5113 6.57819 19.3764C4.40138 17.1391 2.19995 13.9799 2.19995 10.5798ZM8.38442 10.1041C8.38442 8.10725 10.0031 6.48852 12 6.48852C13.9968 6.48852 15.6155 8.10725 15.6155 10.1041C15.6155 12.1009 13.9968 13.7196 12 13.7196C10.0031 13.7196 8.38442 12.1009 8.38442 10.1041Z" fill="currentColor"></path></g></svg></span><font ><font >맨해튼</font></font><span style={{display:"inline-flex"}} className="_1h4pbgy8g8 _1h4pbgy8qg _1h4pbgy85s" data-seed-icon="icon_expand_more_fill" data-seed-icon-version="0.2.1"><svg id="icon_expand_more_fill" width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-karrot-ui-icon="true"><g><path fillRule="evenodd" clipRule="evenodd" d="M2.79289 7.29289C3.18342 6.90237 3.81658 6.90237 4.20711 7.29289L12 15.0858L19.7929 7.29289C20.1834 6.90237 20.8166 6.90237 21.2071 7.29289C21.5976 7.68342 21.5976 8.31658 21.2071 8.70711L12.7071 17.2071C12.3166 17.5976 11.6834 17.5976 11.2929 17.2071L2.79289 8.70711C2.40237 8.31658 2.40237 7.68342 2.79289 7.29289Z" fill="currentColor"></path>
                            </g>
                        </svg>
                    </span>
                </button>
            ...
            <div className="_1h4pbgy9w0 _1h4pbgy8jc _1h4pbgya2z">
                <form action="/us/buy-sell/all/">
                    <div className="_1h4pbgya0o">
                        <input className="_1wcdkwr0 _1wcdkwr1" type="search" aria-label="검색 입력" placeholder="무엇을 찾고 계신가요?" name="search"/>
                        <button type="submit" aria-label="찾다" className="_1wcdkwr5 _1h4pbgy7cg _1h4pbgy7h4 _1h4pbgy7ls _1h4pbgy7qg _1h4pbgya0w _1h4pbgy9dc _1h4pbgy9ps _1h4pbgy9ug _1h4pbgy9wo _1h4pbgy9xc _1h4pbgy1qe _1h4pbgy94o _1h4pbgy9yw">
                            <span style={{display:"inline-flex"}} className="_1h4pbgy8g _1h4pbgy8gg _1h4pbgy8qo" data-seed-icon="icon_search_fill" data-seed-icon-version="0.2.1">
                        ...
                        <div className="_1n1zga85 _1h4pbgy9zk _1h4pbgy8jc">
                            <div className="_1a7kymoq _1h4pbgy7nk _1h4pbgy7o1 _1h4pbgy7oy _1h4pbgy7m3 _1h4pbgy7s8 _1h4pbgy7sp _1h4pbgy7tm _1h4pbgy7qr _1h4pbgy7e8 _1h4pbgy7e3 _1h4pbgy7iw _1h4pbgy7ir _1h4pbgy9uw _1h4pbgy9wo _1h4pbgya54 _1a7kymop _588sy4ph">
                                ...
                                <ul className="_1h4pbgy9ug _1h4pbgy9wo">
                                    <li className="_1a7kymor _1h4pbgy8b4 _1h4pbgy8bf"><Link data-gtm="gnb_popular_keyword" className="_1a7kymos _1h4pbgy7nc _1h4pbgy7lv _1h4pbgy7s0 _1h4pbgy7qj _1h4pbgy8g _1h4pbgy7v _1h4pbgy9ug _1h4pbgy9wo _1h4pbgy76o _1h4pbgy8rk _1h4pbgy8qr _1h4pbgy9yw _1h4pbgy67s _1h4pbgy76b _1h4pbgy95k _1h4pbgy93v" href="/buy-sell/all/?in=manhattan-7426&amp;search=bike"><font ><font >자전거</font></font></Link></li>
...
{/* 로그인 모달 */}
<div style={{pointerEvents: "auto", display:"none"}} id="login_dialog" role="dialog" aria-describedby="radix-:R24pH2:" aria-labelledby="radix-:R24pH1:" data-state="open" className="sboh910 sboh912 sboh915" tabIndex="-1">
<div className="sboh91e">
    <h2 id="radix-:R24pH1:" className="sboh91f">쌍용마켙</h2>
</div>
<div className="_588sy4i8 _588sy4ew _588sy4ne _588sy4k8 _588sy41z _588sy421">
    ...
    <h2 className="_588sy419q _588sy41y _588sy41ak" level="2">로그인</h2>
    ...
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-seed-icon="true" data-seed-icon-version="0.4.0-beta.2" width="24" height="24" style={{width: "100%", height: "100%"}}><g><path fillRule="evenodd" clipRule="evenodd" d="M3.72633 3.72633C4.0281 3.42456 4.51736 3.42456 4.81913 3.72633L12 10.9072L19.1809 3.72633C19.4826 3.42456 19.9719 3.42456 20.2737 3.72633C20.5754 4.0281 20.5754 4.51736 20.2737 4.81913L13.0928 12L20.2737 19.1809C20.5754 19.4826 20.5754 19.9719 20.2737 20.2737C19.9719 20.5754 19.4826 20.5754 19.1809 20.2737L12 13.0928L4.81913 20.2737C4.51736 20.5754 4.0281 20.5754 3.72633 20.2737C3.42456 19.9719 3.42456 19.4826 3.72633 19.1809L10.9072 12L3.72633 4.81913C3.42456 4.51736 3.42456 4.0281 3.72633 3.72633Z" fill="currentColor"></path></g></svg><span className="ar0rax0">Close</span>
    </button>
</div>
</div>
</>
