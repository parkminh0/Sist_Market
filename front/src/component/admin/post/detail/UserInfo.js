    ...
    return (
      <TableContainer className="infoPart" component={Paper}>
        <Table className="detailInfoTable">
          <TableBody>
            <TableRow>
              <TableCell onClick={()=>handleOpen(`${uvo.imgurl}`)} title="원본 이미지 보기" style={{textAlign: "center", cursor:"pointer"}} rowSpan={2} colSpan={5}><img title="원본 이미지 보기" src={`${uvo.imgurl}`} style={{width:100}} /></TableCell>
              <TableCell className="th" colSpan={2}>유저번호</TableCell>
              <TableCell className="th" colSpan={2}>아이디</TableCell>
              <TableCell className="th" colSpan={2}>이름</TableCell>
            </TableRow>
              <TableRow>
                <TableCell className="td" colSpan={2}>{uvo.userkey}</TableCell>
            ...
            <TableRow>
              ...
              <TableRow>
                <TableCell className="td" colSpan={2}>{uvo.nickname}</TableCell>
