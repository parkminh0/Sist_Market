                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div
                        className="mSearchSelect typeCategory theme1"
                      ...
                      <div className="gIcoShop">
                        <div className="overlapTip">
                          <input
                            ...
                            style={{ width: "730px" }}
                            value="${requestScope.pvo.prod_name}"
                          />
                        </div>
                      </div>
                    </td>
                      ...
                      <div className="gIcoShop">
                        <div className="overlapTip">
                          <input
                            ...
                            name="img_url"
                            id="img_url"
                            placeholder="/shop/img/product/ 이후의 이미지 경로를 작성해주세요."
                            className="fText eMarketChecker eHasModifyProductAuth"
                            style={{ width: "730px" }}
            ...
            <div className="mBoard typeProduct">
              <table border="1" summary="">
                ...
                <tbody>
                  <tr>
                    <th scope="row">
                      원가 <strong className="icoRequired">필수 </strong>
                    </th>
                    <td>
                      <input
                        type="number"
                        className="fText right eMarketChecker eHasModifyProductAuth"
                        style={{ width: "80px" }}
                        name="ori_price"
                        id="ori_price"
                        value="${requestScope.pvo.ori_price}"
                        min="0"
                      />
                  ...
                  <tr>
                    <th scope="row">
                      판매가 <strong className="icoRequired">필수</strong>
                    </th>
                    <td>
                      <input
                        type="number"
                        ...
                        name="cell_price"
                        id="cell_price"
                        value="${requestScope.pvo.cell_price}"
                        min="0"
                      />
                      <span className="txtCode">KRW</span>
                    </td>
                  ...
                  <tr>
                    <th scope="row">
                      ...
                      <button
                        type="button"
                        onclick="addOption();"
                        className="btnOption lv1Plus vaBottom"
                      >
                        추가
                      </button>
                    </th>
