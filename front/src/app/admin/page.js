...
export default function Home() {
  return (
    <>
        ...
        <div className="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation1 MuiCard-root css-10kzmkx">
          ...
          <div className="MuiCardContent-root css-bjeup0">
            <div className="MuiGrid-root MuiGrid-container css-1on9dlm">
                ...
                <div className="MuiStack-root css-nw2i60">
                  <div className="MuiStack-root css-1b6n4o1">
                    <div className="MuiStack-root css-zhmvqp">
                      <span className="MuiTypography-root MuiTypography-custom.subTitle3MH css-168a1n3">
                        배송 준비중
                      </span>
                    </div>
                    <div className="MuiStack-root css-278aby">
                      <a
                        className="MuiTypography-root MuiTypography-custom.subTitle3BH MuiLink-root MuiLink-underlineAlways css-zkh9pm"
                        href="#"
                      >
              ...
              <div className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-true css-r3xjrv">
                <div
                  className="MuiStack-root css-nw2i60"
                  style={{ backgroundColor: "rgb(254, 246, 248)" }}
                >
                  <div className="MuiStack-root css-1b6n4o1">
                    <div className="MuiStack-root css-zhmvqp">
                      <span className="MuiTypography-root MuiTypography-custom.subTitle3MH css-168a1n3">
      ...
      <div
        className="MuiGrid-root MuiGrid-item MuiGrid-grid-xs-12 css-he9kdn"
        ...
        <div className="MuiPaper-root MuiPaper-elevation MuiPaper-rounded MuiPaper-elevation1 MuiCard-root css-1lp2lxj">
          <div className="MuiCardContent-root css-1wm5j31">
            <div className="MuiStack-root css-3mgmko">
              <div className="MuiTabs-root hasSpacing css-1a8hjjr">
                ...
                >
                  <div className="MuiTabs-flexContainer css-7sga7m">
                    <button
                      className="MuiButtonBase-root MuiTab-root MuiTab-textColorPrimary MuiTab-fullWidth Mui-selected css-1klvew2"
                      tabIndex="0"
                      data-tab="0"
                      type="button"
                    >
              ...
              <hr
                className="MuiDivider-root MuiDivider-fullWidth lowest css-gdc707"
                color="baseLowTransparent"
              />
            </div>
            {/* <!-- 콘텐츠 --> */}
            <div className="MuiStack-root css-19t4a4d">
              ...
              <div className="MuiGrid-root MuiGrid-container css-336oa0">
                <div
                  className="MuiGrid-root MuiGrid-container MuiGrid-item MuiGrid-grid-xs-6.5 css-1e4n2pt"
                  data-testid="DailySales_Grid_4"
                >
                  <div className="MuiTableContainer-root css-9pnnhu">
                    <table className="MuiTable-root highlight highlight-list-low fixed css-94knn5">
                      <thead className="MuiTableHead-root css-1wbz3t9">
                        <tr className="MuiTableRow-root MuiTableRow-head css-1u6a08m">
                          <th
                            className="MuiTableCell-root MuiTableCell-head MuiTableCell-alignLeft MuiTableCell-paddingNone MuiTableCell-sizeSmall css-1xcxvll"
                            scope="col"
                            color="#f78555"
                          >
                            <div className="MuiStack-root css-zrbz0u">
                              <span
                                className="MuiTypography-root MuiTypography-base.subTitle3M css-ak829n"
                                data-testid="TableHead_Typography"
                              >
                                기간별 매출
                              </span>
                            </div>
                          ...
                          <th
                            className="MuiTableCell-root MuiTableCell-head MuiTableCell-alignLeft MuiTableCell-paddingNone MuiTableCell-sizeSmall css-1a98he0"
                            scope="col"
                            color="#f78555"
                            data-testid="TableHead_TableCell"
                          >
                            <div
                              className="MuiStack-root css-1jxfipj"
                              data-testid="TableHead_Stack"
                            >
                              <span
                                className="MuiTypography-root MuiTypography-base.subTitle3M css-ak829n"
                                data-testid="TableHead_Typography"
                      ...
                      <tbody
                        ...
                        data-testid="TableBody_MuiTableBody"
                      >
                        ...
                        <tr className="MuiTableRow-root css-jhd6ko">
                          <td className="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeSmall css-wfvj3y">
                            <div className="MuiStack-root css-lmzl00">
                              <span className="MuiTypography-root MuiTypography-custom.subTitle3BH css-112v5qi">
                                최근 7일 평균
                              </span>
                            </div>
                          </td>
                          <td className="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeSmall css-wfvj3y">
                            <div className="MuiStack-root css-s3sz5j">
                              <div
                                className="MuiStack-root css-1tlqmrq"
                                data-testid="TableBodyCell_Stack_2"
                              >
                                <div
                                  className="MuiStack-root css-1biq3zq"
                                  data-testid="TableBodyCell_Stack_3"
                                >
                                  <span
                                    className="MuiTypography-root MuiTypography-base.body2 css-1uxqc2"
                                    data-testid="TableBodyCell_Typography_2"
                                  >
                                    {/* <fmt:formatNumber value="${order_price_7 / 7 }" pattern="#,###.00"/> */}
                                  </span>
                                  <span
                                    className="MuiTypography-root MuiTypography-base.body2 unit css-1m3dqce"
                                    data-testid="TableBodyCell_Typography_3"
                                  >
                                    원
                                  </span>
                                </div>
                                <div
                                  className="MuiChip-root MuiChip-filled MuiChip-sizeX4Small MuiChip-colorDecoBluePurpleLowBaseHigh MuiChip-filledDecoBluePurpleLowBaseHigh css-pm13i0"
                                  data-testid="TableBodyCell_Chip_1"
                                >
                          ...
                          <td
                            className="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeSmall css-wfvj3y"
                            data-testid="TableBodyCell_TableCell_1"
                          >
                            <div
                              className="MuiStack-root css-s3sz5j"
                              data-testid="TableBodyCell_Stack_1"
                            >
                              <div
                                className="MuiStack-root css-1tlqmrq"
                                data-testid="TableBodyCell_Stack_2"
                        ...
                        <tr
                          className="MuiTableRow-root css-1cxpyww"
                          data-testid="TableBody_TableRow"
                        >
                          <td
                            className="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeSmall css-wfvj3y"
                            data-testid="TableBodyCell_TableCell_1"
                          >
                            <div
                              className="MuiStack-root css-r6kl0b"
                              data-testid="TableBodyCell_Stack_1"
                            >
                              <div
                                className="MuiStack-root css-yacjjn"
                                data-testid="TableBodyCell_Stack_4"
                              >
                                <span
                                  className="MuiTypography-root MuiTypography-custom.subTitle3MH css-1q3reqo"
                                  data-testid="TableBodyCell_Typography_5"
                                >
                                  최근 7일 합계
                                </span>
                              </div>
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  <span
                                    className="MuiTypography-root MuiTypography-base.body2 css-mr3nge"
                                    data-testid="TableBodyCell_Typography_2"
                                  >
                                ...
                                <div
                                  className="MuiChip-root MuiChip-filled MuiChip-sizeX4Small MuiChip-colorDecoGrayLowBaseHigh MuiChip-filledDecoGrayLowBaseHigh css-1o8x7id"
                                  data-testid="TableBodyCell_Chip_1"
                                >
                                  <span className="MuiChip-label MuiChip-labelX4Small css-v1l1sd">
                        ...
                        <tr
                          className="MuiTableRow-root css-jhd6ko"
                          data-testid="TableBody_TableRow"
                        >
                          <td
                            className="MuiTableCell-root MuiTableCell-body MuiTableCell-sizeSmall css-wfvj3y"
                            data-testid="TableBodyCell_TableCell"
                          >
                            <div
                              className="MuiStack-root css-lmzl00"
                              data-testid="TableBodyCell_Stack"
                            >
                              <span
                                className="MuiTypography-root MuiTypography-custom.subTitle3BH css-112v5qi"
                                data-testid="TableBodyCell_Typography"
                              >
                                최근 30일 합계
                              </span>
                            </div>
